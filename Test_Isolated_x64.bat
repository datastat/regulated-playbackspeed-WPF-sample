...
rem rem Delete old
del ".\bin\x64\Debug\Sample File Playback WPF.exe.manifest" /f /q
...
copy ..\..\..\Bin\Manifests\x64\[YourApplicationExeFile].exe.manifest ".\bin\x64\Debug\Sample File Playback WPF.exe.manifest" /y 
