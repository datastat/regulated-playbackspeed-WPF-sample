...
rem Delete old
del ".\bin\x86\Debug\Sample File Playback WPF.exe.manifest" /f /q
...
copy ..\..\..\Bin\Manifests\x86\[YourApplicationExeFile].exe.manifest ".\bin\x86\Debug\Sample File Playback WPF.exe.manifest" /y 

rem Run
cd .\bin\x86\Debug
"Sample File Playback WPF.exe"
